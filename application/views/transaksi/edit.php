...
<?= form_open('', '', ['id_transaksi' => $id_transaksi, 'user_id' => $user]); ?>
<form>
    ...
    <div class="form-group">
        ...
        <input type="text" value="<?= set_value('waktu', date('H:i')) ?>" class="form-control" name="waktu" id="waktu" placeholder="Tanggal Transaksi">
        <?= form_error('waktu'); ?>
    </div>
    <div class="form-group">
        ...
        <select class="form-control" name="kategori_id" id="kategori_id">
            ...
            <?php foreach ($kategori as $k) : ?>
                <option <?= set_select('kategori_id', $k->id_kategori); ?> value="<?= $k->id_kategori ?>"><?= $k->nama_kategori ?></option>
            <?php endforeach; ?>
        </select>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="number" value="<?= set_value('jumlah'); ?>" minlength="0" class="form-control" name="jumlah" id="jumlah" placeholder="0">
